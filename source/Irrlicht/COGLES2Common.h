...
namespace video
{
    ...
    typedef COpenGLCoreRenderBuffer<COGLES2Driver> COGLES2RenderBuffer;
	typedef COpenGLCoreRenderTarget<COGLES2Driver, COGLES2Texture, COGLES2RenderBuffer> COGLES2RenderTarget;
