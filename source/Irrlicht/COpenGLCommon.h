...
namespace video
{
    ...
    typedef COpenGLCoreRenderBuffer<COpenGLDriver> COpenGLRenderBuffer;
	typedef COpenGLCoreRenderTarget<COpenGLDriver, COpenGLTexture, COpenGLRenderBuffer> COpenGLRenderTarget;
